...
namespace Damage_TestConsole
{
    internal class W_Engines_A_rank
    {
        public class Main
        {
            ...
            {
                double Wengine_StarlightEngine_Main = 594;
            }
        ...
        public class Sub
        {
            public class ATK_Bufs
            {
                ...
                public class StarlightEngine
                {
                    double Wengine_StarlightEngine_Sub_ATK = 0.25;
                }
                public class GildedBlossom
                {
            ...
            public class EnergyRegen_Bufs
            {
                public class DrillRigRedAxis
                {
                    double Wengine_DrillRigRedAxis_Sub_EnergyRegen = 0.5;
                }
                public class SteamOven
                {
                    double Wengine_SteamOven_Sub_EnergyRegen = 0.5;
                }
                public class TheVault
                {
        ...
        { 
            public class DMG
            {
                ...
                {
                    //Ult DMG
                    double[] Wengine_StreetSuperstar_Pasive_DMG_stack_1 = { 0.15, 0.172, 0.195, 0.217, 0.24 };
                    double[] Wengine_StreetSuperstar_Pasive_DMG_stack_2 = { 0.3, 0.344, 0.39, 0.434, 0.48 };
                    double[] Wengine_StreetSuperstar_Pasive_DMG_stack_3 = { 0.45, 0.516, 0.585, 0.651, 0.72 };
                }
                public class GildedBlossom
                {
                    //EX
                    double[] Wengine_GildedBlossom_Pasive_DMG = { 0.06, 0.069, 0.078, 0.087, 0.096 };
                }
                public class Housekeeper
                {
                    //Physical DMG
                    double[] Wengine_Housekeeper_Pasive_DMG_stack_1 = { 0.03, 0.035, 0.04, 0.044, 0.048 };
                    double[] Wengine_Housekeeper_Pasive_DMG_stack_2 = { 0.06, 0.07, 0.08, 0.088, 0.096 };
                    double[] Wengine_Housekeeper_Pasive_DMG_stack_3 = { 0.09, 0.105, 0.12, 0.132, 0.144 };
                    double[] Wengine_Housekeeper_Pasive_DMG_stack_4 = { 0.012, 0.14, 0.16, 0.176, 0.192 };
                    double[] Wengine_Housekeeper_Pasive_DMG_stack_5 = { 0.015, 0.175, 0.2, 0.22, 0.24 };
                    double[] Wengine_Housekeeper_Pasive_DMG_stack_6 = { 0.18, 0.21, 0.24, 0.264, 0.288 };
                    double[] Wengine_Housekeeper_Pasive_DMG_stack_7 = { 0.21, 0.245, 0.28, 0.308, 0.336 };
                    double[] Wengine_Housekeeper_Pasive_DMG_stack_8 = { 0.24, 0.28, 0.32, 0.352, 0.384 };
                    double[] Wengine_Housekeeper_Pasive_DMG_stack_9 = { 0.27, 0.315, 0.36, 0.396, 0.432 };
                    double[] Wengine_Housekeeper_Pasive_DMG_stack_10 = { 0.3, 0.35, 0.4, 0.44, 0.48 };
                    double[] Wengine_Housekeeper_Pasive_DMG_stack_11 = { 0.33, 0.385, 0.44, 0.484, 0.528 };
                    double[] Wengine_Housekeeper_Pasive_DMG_stack_12 = { 0.36, 0.42, 0.48, 0.528, 0.576 };
                    double[] Wengine_Housekeeper_Pasive_DMG_stack_13 = { 0.39, 0.455, 0.52, 0.572, 0.624 };
                    double[] Wengine_Housekeeper_Pasive_DMG_stack_14 = { 0.42, 0.49, 0.56, 0.616, 0.672 };
                    double[] Wengine_Housekeeper_Pasive_DMG_stack_15 = { 0.45, 0.525, 0.6, 0.66, 0.72 };
                }
                public class StarlightEngineReplica
                {
                    //Physical DMG
                    double[] Wengine_StarlightEngineReplica_Pasive_DMG = { 0.36, 0.41, 0.465, 0.52, 0.575 };
                }
                public class DrillRigRedAxis
                {
                    //Basic or Dash, Electric DMG
                    double[] Wengine_DrillRigRedAxis_Pasive_DMG = { 0.5, 0.575, 0.65, 0.725, 0.8 };
                }
                public class DemaraBatteryMarkII
                {
                    //Electric DMG
                    double[] Wengine_DemaraBatteryMarkII_Pasive_DMG = { 0.15, 0.175, 0.2, 0.22, 0.24 };
                }
                public class BoxCutter
                {
                    //Physical DMG
                    double[] Wengine_BoxCutter_Pasive_DMG = { 0.15, 0.173, 0.195, 0.218, 0.24 };
                }
                public class ElectroLipGloss
                {
                ...
                {
                    //Ice DMG
                    double[] Wengine_BashfulDemon_Pasive_DMG = { 0.15, 0.175, 0.2, 0.22, 0.24, };
                }
                public class TremorTrigramVessel
                {
                ...
                {
                    //EX
                    double[] Wengine_PuzzleSphere_Pasive_DMG = { 0.2, 0.23, 0.26, 0.29, 0.32 };
                }
            }
            public class ATK_Bufs
            {
                ...
                public class MarcatoDesire
                {
                    double[] Wengine_MarcatoDesire_Pasive_ATK_1 = { 0.06, 0.069, 0.078, 0.087, 0.096 };
                    double[] Wengine_MarcatoDesire_Pasive_ATK_2 = { 0.06, 0.069, 0.078, 0.087, 0.096 };
                }
                public class RainforestGourmet
                {
                ...
                {
                    //all squad
                    double[] Wengine_BashfulDemon_Pasive_ATK = { 0.02, 0.023, 0.026, 0.029, 0.032 };
                }
                public class KaboomtheCannon
                {
                    //all squad
                    double[] Wengine_KaboomtheCannon_Pasive_ATK_stac_1 = { 0.025, 0.028, 0.032, 0.036, 0.04 };
                    double[] Wengine_KaboomtheCannon_Pasive_ATK_stac_2 = { 0.05, 0.056, 0.064, 0.072, 0.08 };
                    double[] Wengine_KaboomtheCannon_Pasive_ATK_stac_3 = { 0.075, 0.084, 0.096, 0.108, 0.12 };
                    double[] Wengine_KaboomtheCannon_Pasive_ATK_stac_4 = { 0.1, 0.112, 0.128, 0.144, 0.16 };
                }
                public class BunnyBand
                {
