...
namespace Damage_TestConsole
{
    internal class W_Engines_S_rank
    {
        public class Main
        {
            ...
            {
                double Wengine_HailstormShrine_Main = 743;
            }
        ...
        public class Sub
        {
            ...
            public class Impact_Bufs
            {
                ...
                public class BlazingLaurel
                {
                    double Wengine_BlazingLaurel_Sub_Impact = 0.18;
                }
            }
        ...
        public class Pasive
        {
            public class DMG_Bufs
            {
                ...
                {
                    //Physical
                    double[] Wengine_SteelCushion_Pasive_DMG_1 = { 0.2, 0.25, 0.3, 0.35, 0.4 };
                    double[] Wengine_SteelCushion_Pasive_DMG_2 = { 0.25, 0.315, 0.38, 0.44, 0.5 };
                }
                public class DeepSeaVisitor
                {
                    //Ice
                    double[] Wengine_DeepSeaVisitor_Pasive_DMG = { 0.25, 0.315, 0.38, 0.445, 0.5 };
                }
                public class ZanshinHerbCase
                {
                    //DashElectric
                    double[] Wengine_ZanshinHerbCase_Pasive_DMG = { 0.4, 0.46, 0.52, 0.58, 0.64 };
                }
                public class RiotSuppressorMarkVI
                {
                    //Basic or Dash
                    double[] Wengine_RiotSuppressorMarkVI_Pasive_DMG = { 0.35, 0.435, 0.52, 0.605, 0.7 };
                }
                public class CordisGermina
                {
                    //Electric
                    double[] Wengine_CordisGermina_Pasive_DMG = { 0.125, 0.145, 0.165, 0.185, 0.2 };
                }
                public class TheRestrained
                {
                    //Basic
                    double[] Wengine_TheRestrained_Pasive_DMG = { 0.06, 0.075, 0.09, 0.105, 0.12 };
                }
                public class SeveredInnocence
                {
                ...
                {
                    //allsquad
                    double[] Wengine_IceJadeTeapot_Pasive_DMG = { 0.2, 0.23, 0.26, 0.29, 0.32 };
                }
                public class HailstormShrine
                {
                    //ex or anomaly Ice
                    double[] Wengine_HailstormShrine_Pasive_DMG_stac_1 = { 0.2, 0.23, 0.26, 0.29, 0.32 };
                    double[] Wengine_HailstormShrine_Pasive_DMG_stac_2 = { 0.4, 0.46, 0.52, 0.58, 0.64 };
                }
                public class SharpenedStinger
                {
                    //Physical
                    double[] Wengine_SharpenedStinger_Pasive_DMG_stac_1 = { 0.12, 0.15, 0.18, 0.21, 0.24 };
                    double[] Wengine_SharpenedStinger_Pasive_DMG_stac_2 = { 0.24, 0.30, 0.36, 0.42, 0.48 };
                    double[] Wengine_SharpenedStinger_Pasive_DMG_stac_3 = { 0.36, 0.45, 0.54, 0.63, 0.72 };
                }
                public class WeepingCradle
                {
                ...
                {
                    //Ice_Sheer
                    double[] Wengine_KrakensCradle_Pasive_DMG_stac_1 = { 0.06, 0.07, 0.08, 0.09, 0.1 };
                    double[] Wengine_KrakensCradle_Pasive_DMG_stac_2 = { 0.12, 0.14, 0.16, 0.18, 0.2 };
                    double[] Wengine_KrakensCradle_Pasive_DMG_stac_3 = { 0.18, 0.21, 0.24, 0.27, 0.3 };
                }
                public class QingmingBirdcage
                {
                    //Ether
                    double[] Wengine_QingmingBirdcage_Pasive_DMG_stac_1 = { 0.08, 0.092, 0.104, 0.116, 0.128 };
                    double[] Wengine_QingmingBirdcage_Pasive_DMG_stac_2 = { 0.16, 0.184, 0.208, 0.232, 0.256 };
                    //Ether Sheer
                    double[] Wengine_QingmingBirdcage_Pasive_DMG_Ultimate_EX_stac_1 = { 0.1, 0.115, 0.13, 0.145, 0.16 };
                    double[] Wengine_QingmingBirdcage_Pasive_DMG_Ultimate_EX_stac_2 = { 0.2, 0.23, 0.26, 0.29, 0.32 };
                }
                public class RoaringFurnace
                {
                    //all sqad
                    double[] Wengine_RoaringFurnace_Pasive_DGM = { 0.1, 0.115, 0.13, 0.145, 0.16 };
                }
                public class FlamemakerShaker
                {
                    double[] Wengine_FlamemakerShaker_Pasive_DMG_stac_1 = { 0.035, 0.044, 0.052, 0.061, 0.07 };
                    double[] Wengine_FlamemakerShaker_Pasive_DMG_stac_2 = { 0.07, 0.088, 0.104, 0.122, 0.14 };
                    double[] Wengine_FlamemakerShaker_Pasive_DMG_stac_3 = { 0.105, 0.132, 0.156, 0.183, 0.21 };
                    double[] Wengine_FlamemakerShaker_Pasive_DMG_stac_4 = { 0.14, 0.176, 0.208, 0.244, 0.28 };
                    double[] Wengine_FlamemakerShaker_Pasive_DMG_stac_5 = { 0.175, 0.22, 0.26, 0.305, 0.35 };
                    double[] Wengine_FlamemakerShaker_Pasive_DMG_stac_6 = { 0.21, 0.264, 0.312, 0.366, 0.42 };
                    double[] Wengine_FlamemakerShaker_Pasive_DMG_stac_7 = { 0.245, 0.308, 0.364, 0.427, 0.49 };
                    double[] Wengine_FlamemakerShaker_Pasive_DMG_stac_8 = { 0.28, 0.352, 0.416, 0.488, 0.56 };
                    double[] Wengine_FlamemakerShaker_Pasive_DMG_stac_9 = { 0.315, 0.396, 0.468, 0.549, 0.63 };
                    double[] Wengine_FlamemakerShaker_Pasive_DMG_stac_10 = { 0.35, 0.44, 0.52, 0.61, 0.7 };
                }
            }
            ...
            public class CritDMG_Bufs
            {
                ...
                {
                    //only Ice Fire
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_1 = { 0.015, 0.0172, 0.0195, 0.0217, 0.024 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_2 = { 0.03, 0.0344, 0.039, 0.0434, 0.048 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_3 = { 0.045, 0.0516, 0.0585, 0.0651, 0.072 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_4 = { 0.06, 0.0688, 0.078, 0.0868, 0.096 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_5 = { 0.075, 0.086, 0.0975, 0.1085, 0.12 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_6 = { 0.09, 0.1032, 0.117, 0.1302, 0.144 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_7 = { 0.105, 0.1204, 0.1365, 0.1519, 0.168 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_8 = { 0.12, 1376, 0.186, 0.1736, 0.192 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_9 = { 0.135, 0.1548, 0.1755, 0.1953, 0.216 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_10 = { 0.15, 0.172, 0.195, 0.217, 0.24 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_11 = { 0.165, 0.1892, 0.2145, 0.2387, 0.264 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_12 = { 0.18, 0.2064, 0.234, 0.2604, 0.288 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_13 = { 0.195, 0.2236, 0.2535, 0.2821, 0.312 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_14 = { 0.21, 0.2408, 0.273, 0.3038, 0.336 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_15 = { 0.225, 0.258, 0.2925, 0.3255, 0.36 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_16 = { 0.24, 0.2752, 0.312, 0.3472, 0.384 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_17 = { 0.255, 0.2924, 0.3315, 0.3689, 0.408 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_18 = { 0.27, 0.3096, 0.351, 0.3906, 0.432 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_19 = { 0.285, 0.3268, 0.3705, 0.4123, 0.456 };
                    double[] Wengine_BlazingLaurel_Pasive_CritDMG_stac_20 = { 0.3, 0.344, 0.39, 0.434, 0.48 };
                }
                public class HailstormShrine
                {
            ...
            public class CritRate_Bufs
            {
                public class DeepSeaVisitor
                {
                    double[] Wengine_DeepSeaVisitor_Pasive_CritRate_1 = { 0.1, 0.125, 0.15, 0.175, 0.2 };
                    //if IceDng
                    double[] Wengine_DeepSeaVisitor_Pasive_CritRate_2 = { 0.1, 0.125, 0.15, 0.175, 0.2 };
                }
                public class ZanshinHerbCase
                {
                    double[] Wengine_ZanshinHerbCase_Pasive_CritRate_1 = { 0.1, 0.115, 0.13, 0.145, 0.16 };
                    //if Anomaly or Stun 
                    double[] Wengine_ZanshinHerbCase_Pasive_CritRate_2 = { 0.1, 0.115, 0.13, 0.145, 0.16 };
                }
                public class RiotSuppressorMarkVI
                {
                ...
                public class CordisGermina
                {
                    double[] Wengine_CordisGermina_Pasive_CritRate = { 0.15, 0.17, 0.19, 0.21, 0.23 };
                }
            }
            public class ATK_Bufs
            {
                public class Brimstone
                {
                    double[] Wengine_Brimstone_Pasive_ATK_stac_1 = { 0.035, 0.044, 0.052, 0.06, 0.07 };
                    double[] Wengine_Brimstone_Pasive_ATK_stac_2 = { 0.07, 0.088, 0.104, 0.12, 0.14 };
                    double[] Wengine_Brimstone_Pasive_ATK_stac_3 = { 0.105, 0.132, 0.156, 0.18, 0.21 };
                    double[] Wengine_Brimstone_Pasive_ATK_stac_4 = { 0.14, 0.176, 0.208, 0.24, 0.28 };
                    double[] Wengine_Brimstone_Pasive_ATK_stac_5 = { 0.175, 0.22, 0.26, 0.3, 0.35 };
                    double[] Wengine_Brimstone_Pasive_ATK_stac_6 = { 0.21, 0.264, 0.312, 0.36, 0.42 };
                    double[] Wengine_Brimstone_Pasive_ATK_stac_7 = { 0.245, 0.308, 0.364, 0.42, 0.49 };
                    double[] Wengine_Brimstone_Pasive_ATK_stac_8 = { 0.28, 0.352, 0.416, 0.48, 0.56 };
                }
                public class FusionCompiler
                {
            ...
            public class Impact_Bufs
            {
                ...
                {
                    //ex
                    double[] Wengine_HellfireGears_Pasive_Impact_stac_1 = { 0.1, 0.125, 0.15, 0.175, 0.2 };
                    double[] Wengine_HellfireGears_Pasive_Impact_stac_2 = { 0.2, 0.25, 0.3, 0.35, 0.4 };
                }
                public class BlazingLaurel
                {
                ...
                public class SpectralGaze
                {
                    ...
                    //FullStac
                    double[] Wengine_SpectralGaze_Impact = { 0.08, 0.092, 0.0104, 0.116, 0.128 };
                }
            }
            ...
            public class AP_Bufs
            {
                public class FlamemakerShaker
                {
                    double[] Wengine_FlamemakerShaker_Pasive_AP_5_10_stac = { 50, 62, 75, 87, 100 };
                }
                public class FusionCompiler
                {
            ...
            public class HP_Bufs
            {
                ...
                {
                    //all_sqad
                    double[] Wengine_DreamlitHearth_Pasive_HP = { 0.15, 0.173, 0.195, 0.218, 0.24 };
                }
            }
        }
    }
